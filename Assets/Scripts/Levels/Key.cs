...
public class Key : MonoBehaviour
{
    ...
    private float[] _keyColliderRadii = {1f, 1.5f, 1.9f, 2.25f}; //size of coin collider for different moneyGrab upgrade levels
    ...
    void Start() {
        ...
        keyCollider.radius = _keyColliderRadii[GameManager.upgradeLevels[1]];
    }
